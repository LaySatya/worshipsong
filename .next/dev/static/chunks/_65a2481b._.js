...
"[project]/app/components/SongModal.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function SongModal({ song, open, onClose, allSongs = [], onSongSelect }) {
    ...
    const parseLyrics = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "SongModal.useCallback[parseLyrics]": (lyrics)=>{
            if (!lyrics) return [];
            return lyrics.split(/\n\n+/).map({
                "SongModal.useCallback[parseLyrics]": (verse, index)=>({
                        label: verse.split('\n')[0] || `Verse ${index + 1}`,
                        content: verse
                    })
            }["SongModal.useCallback[parseLyrics]"]);
        }
    }["SongModal.useCallback[parseLyrics]"], []);
    ...
    const recommendedSongs = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "SongModal.useMemo[recommendedSongs]": ()=>{
            if (!song || !allSongs.length) return [];
            const others = allSongs.filter({
                "SongModal.useMemo[recommendedSongs].others": (s)=>s.id !== song.id
            }["SongModal.useMemo[recommendedSongs].others"]);
    ...
    const lyricVerses = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "SongModal.useMemo[lyricVerses]": ()=>parseLyrics(song?.lyrics)
    }["SongModal.useMemo[lyricVerses]"], [
        song?.lyrics,
        parseLyrics
    ]);
    const copyLyrics = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "SongModal.useCallback[copyLyrics]": async ()=>{
            if (!song?.lyrics) return;
            try {
                await navigator.clipboard.writeText(song.lyrics);
                setCopied(true);
                setTimeout({
                    "SongModal.useCallback[copyLyrics]": ()=>setCopied(false)
                }["SongModal.useCallback[copyLyrics]"], 2000);
            } catch (e) {
                console.error('copy failed', e);
            }
        }
    }["SongModal.useCallback[copyLyrics]"], [
        song?.lyrics
    ]);
    const copyVerse = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "SongModal.useCallback[copyVerse]": async (content)=>{
            try {
    ...
    }["SongModal.useCallback[copyVerse]"], []);
    const handleSongClick = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "SongModal.useCallback[handleSongClick]": (recSong)=>{
            if (onSongSelect) {
                onSongSelect(recSong);
            }
        }
    }["SongModal.useCallback[handleSongClick]"], [
        onSongSelect
    ]);
    if (!song) return null;
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(SongModal, "/mBOsaDQID4p9qUCozOAxYUEAzo=");
_c = SongModal;
var _c;
__turbopack_context__.k.register(_c, "SongModal");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$components$2f$SongModal$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/components/SongModal.tsx [app-client] (ecmascript)");
...
function SongList() {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$components$2f$SongModal$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                song: selected,
                open: open,
                onClose: close,
...
_s(SongList, "kdIZsmtSKojt0xw7v0o1op2PcGY=");
_c = SongList;
var _c;
...
//# sourceMappingURL=_65a2481b._.js.map