...
function SongDetailPage() {
    ...
    const [activeTab, setActiveTab] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('lyrics');
    const song = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "SongDetailPage.useMemo[song]": ()=>{
            return __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$songs$2e$json__$28$json$29$__["default"].find({
                "SongDetailPage.useMemo[song]": (s)=>s.id === params.id
            }["SongDetailPage.useMemo[song]"]);
        }
    }["SongDetailPage.useMemo[song]"], [
        params.id
    ...
    const parseLyrics = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "SongDetailPage.useCallback[parseLyrics]": (lyrics)=>{
            if (!lyrics) return [];
            return lyrics.split(/\n\n+/).map({
                "SongDetailPage.useCallback[parseLyrics]": (verse, index)=>({
                        label: verse.split('\n')[0] || `Verse ${index + 1}`,
                        content: verse
                    })
            }["SongDetailPage.useCallback[parseLyrics]"]);
        }
    }["SongDetailPage.useCallback[parseLyrics]"], []);
    // Get recommended songs (random songs excluding current)
    const recommendedSongs = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "SongDetailPage.useMemo[recommendedSongs]": ()=>{
            if (!song || !__TURBOPACK__imported__module__$5b$project$5d2f$data$2f$songs$2e$json__$28$json$29$__["default"].length) return [];
            const others = __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$songs$2e$json__$28$json$29$__["default"].filter({
                "SongDetailPage.useMemo[recommendedSongs].others": (s)=>s.id !== song.id
            }["SongDetailPage.useMemo[recommendedSongs].others"]);
            return shuffleArray(others).slice(0, 3);
        }
    }["SongDetailPage.useMemo[recommendedSongs]"], [
        song
    ]);
    const lyricVerses = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "SongDetailPage.useMemo[lyricVerses]": ()=>parseLyrics(song?.lyrics)
    }["SongDetailPage.useMemo[lyricVerses]"], [
        song,
        parseLyrics
    ]);
    const copyLyrics = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "SongDetailPage.useCallback[copyLyrics]": async ()=>{
            if (!song?.lyrics) return;
            try {
                await navigator.clipboard.writeText(song.lyrics);
                setCopied(true);
                setTimeout({
                    "SongDetailPage.useCallback[copyLyrics]": ()=>setCopied(false)
                }["SongDetailPage.useCallback[copyLyrics]"], 2000);
            } catch (e) {
                console.error('copy failed', e);
            }
        }
    }["SongDetailPage.useCallback[copyLyrics]"], [
        song
    ]);
    const copyVerse = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "SongDetailPage.useCallback[copyVerse]": async (content)=>{
            try {
    ...
    }["SongDetailPage.useCallback[copyVerse]"], []);
    const handleSongClick = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "SongDetailPage.useCallback[handleSongClick]": (songId)=>{
            router.push(`/song/${songId}`);
        }
    }["SongDetailPage.useCallback[handleSongClick]"], [
        router
    ]);
    if (!song) {
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    song.artist && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    ...
                                    activeTab === 'lyrics' ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: lyricVerses.map((verse, index)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            recommendedSongs.length > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                className: "mb-10",
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h2", {
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: recommendedSongs.map((recSong)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                                ...
                                                children: [
                                                    ...
                                                    recSong.artist && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
...
_s(SongDetailPage, "6edfQxhWNgL0ze4b9rR4VfmuwXo=", false, function() {
    return [
...
//# sourceMappingURL=_c3a57536._.js.map